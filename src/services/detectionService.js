 ...
 */
export const detectObjects = async (model, imageElement, modelConfig) => {
 ...
 */
export const filterDetections = (results, confidenceThreshold, classFilter = []) => {
 ...
 */
export const applyNonMaxSuppression = (detections, iouThreshold = 0.5) => {
